...
Every report is generated by a script and regenerates from the raw data; none
is hand-written. All contain aggregates only — no row-level data, enforced in CI.

| Report | What's in it |
|---|---|
| [Data quality assessment](reports/data_quality_report.md) | 12 findings across all 36M events — ordering, duplicates, referential integrity, funnel integrity |
| [Customer journey & funnel](reports/funnel_analysis.md) | Both funnel definitions, cart abandonment, session depth, time-to-purchase |
| [Search analytics](reports/search_analysis.md) | Zero-result rate, CTR, position bias, click→purchase attribution |
| [Product & commercial](reports/product_analysis.md) | Catalog coverage, category performance, price sensitivity, demand concentration |
| [Purchase-intent model](reports/ml_purchase_intent.md) | Cart-abandonment prediction, temporal validation, leakage analysis |
...
![Funnel measured two ways](reports/figures/funnel.png)
...
![Catalog coverage cross-tab](reports/figures/catalog_coverage.png)
